...
func spell_2_follow():
	if player.player_id == StageManager.p1_id:
		$SpellHitbox.global_position = $Hitbox.global_position.lerp(StageManager.p1_target,0.005)
		$SpellFX.global_position = $SpellFX.global_position.lerp(StageManager.p1_target,0.005)
	else:
		$SpellHitbox.global_position = $Hitbox.global_position.lerp(StageManager.p2_target,0.005)
